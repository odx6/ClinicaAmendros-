                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="" placeholder="Accidentes" name="EAccidentes">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="" placeholder="Cáncer" name="ECancer">
                            </div>
                        </td>
                        <td>
                            <div class="switch form-switch-custom switch-inline form-switch-success">
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="" placeholder="Cardiopatias" name="ECardiopatias">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="" placeholder="Transfunciones" name="ETransfunciones">
                            </div>
                        </td>
                        <td>
                            <div class="switch form-switch-custom switch-inline form-switch-success">
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="" placeholder="Cirugias" name="ECirugias">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="" placeholder="Fracturas" name="EFracturas">
                            </div>
                        </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="" placeholder="Temp" name="Temp">
                                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="switch form-switch-custom switch-inline form-switch-success">
                                                ...
                                                <input class="switch-input" type="checkbox" role="switch"
                                                    id="form-custom-switch-success" name="Espasmos" value="si">
