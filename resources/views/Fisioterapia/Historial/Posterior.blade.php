                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control POS" id="exampleFormControlInput1" name="Posturas[{{ $Dat }}][Nombre]"
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control POS" id="exampleFormControlInput1"
