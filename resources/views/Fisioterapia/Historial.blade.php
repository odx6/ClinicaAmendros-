...
@section('content')
            ...
            <div class="middle-content container-xxl p-0">
                ...
                <!--end  radio -->
                    ...
                    <!--End-Exploraciones-->
                      <!--radio boton-->
                <div class="switch form-switch-custom switch-inline form-switch-info">
                    <input class="switch-input" type="checkbox" role="switch" id="FisioTrata"
                        name="FisioTrata" value="1">
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Tratamientos  el paciente?</label>
                </div>
                <!--end  radio -->
                    <!--tratamientos-->
   ...
   <!--radio boton-->
                <div class="switch form-switch-custom switch-inline form-switch-info">
                    <input class="switch-input" type="checkbox" role="switch" id="FisioAnte"
                        name="FisioAnte" value="1">
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Antecedentes  el paciente?</label>
                </div>
                <!--end  radio -->
                    <!--tratamientos-->
                ...
                <div class="switch form-switch-custom switch-inline form-switch-info">
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Habitos de salud  el paciente?</label>
                </div>
                <!--end  radio -->
                    <!--Habitos-->
                    ...
                    <!--End-Habitos-->
                       <!--radio boton-->
                <div class="switch form-switch-custom switch-inline form-switch-info">
                    <input class="switch-input" type="checkbox" role="switch" id="FisioIngra"
                        name="FisioIngra" value="1">
                    <label class="switch-label" for="form-custom-switch-info">¿Esta en estado de Ingravidez  el paciente?</label>
                </div>
                <!--end  radio -->
                    <!--Ingravidez-->
                ...
                <div class="switch form-switch-custom switch-inline form-switch-info">
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Diagnóstico Médico  en Rehabilitación el paciente?</label>
                </div>
                <!--end  radoDiagnostico-->
                    <!--Diagnostico-->
   ...
   <!--radio boton-->
                <div class="switch form-switch-custom switch-inline form-switch-info">
                    <input class="switch-input" type="checkbox" role="switch" id="FisioCica"
                        name="FisioCica" value="1">
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Cicatríz Quirúrgica el paciente?</label>
                </div>
                <!--end  radio -->
                    <!--Cicatriz-->
                ...
                <div class="switch form-switch-custom switch-inline form-switch-info">
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Traslados el paciente?</label>
                </div>
                    <!--Cicatriz-->
                ...
                <div class="switch form-switch-custom switch-inline form-switch-info">
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Escala de dolor el paciente?</label>
                </div>
                    <!--Dolor-->
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Evaluacion Muscular el paciente?</label>
                </div>
                      <!--Muscular-->
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Nota de  Valoracion inicial el paciente?</label>
                </div>
                     <!--Muscular-->
  ...
  <div class="switch form-switch-custom switch-inline form-switch-info">
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Evaluación de postura frontal   el paciente?</label>
                </div>
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Evaluacion en la postura lateral  el paciente?</label>
                </div>
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Evaluacion en la posturPosterior  el paciente?</label>
                </div>
                    <!--MuscMiembroSolo-->
...
<div class="switch form-switch-custom switch-inline form-switch-info">
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Formulario  de valoración de la batería breve valoración funcional  ?</label>
                </div>
 <!--MuscMiembroSolo-->
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Plan Analítico  el paciente?</label>
                </div>
                    <!--MuscMiembroSolo-->
                    ...
                    <label class="switch-label" for="form-custom-switch-info">¿Tiene Analisis  de marcha el paciente?</label>
                </div>
                    <!--MuscMiembroSolo-->
