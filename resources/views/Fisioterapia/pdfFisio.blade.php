                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select form-select-lg mb-3"
                                            ...
                                            <option value="0" @if ($eva->val_iquierda == 0) selected @endif>
                                                Grado 0</option>
                                            <option value="1" @if ($eva->val_iquierda == 1) selected @endif>
                                                Grado 1</option>
                                            <option value="2" @if ($eva->val_iquierda == 2) selected @endif>
                                                Grado 2</option>
                                            <option value="3" @if ($eva->val_iquierda == 3) selected @endif>
                                                Grado 3</option>
                                            <option value="4" @if ($eva->val_iquierda == 4) selected @endif>
                                                Grado 4</option>
                                            <option value="5" @if ($eva->val_iquierda == 5) selected @endif>
                                                Grado 5</option>
                                        </select>
                                    </td>
                                    <td>
                                        <select class="form-select form-select-lg mb-3"
                                            ...
                                            <option value="0" @if ($eva->val_derecha == 0) selected @endif>
                                                Grado 0</option>
                                            <option value="1" @if ($eva->val_derecha == 1) selected @endif>
                                                Grado 1</option>
                                            <option value="2" @if ($eva->val_derecha == 2) selected @endif>
                                                Grado 2</option>
                                            <option value="3" @if ($eva->val_derecha == 3) selected @endif>
                                                Grado 3</option>
                                            <option value="4" @if ($eva->val_derecha == 4) selected @endif>
                                                Grado 4</option>
                                            <option value="5" @if ($eva->val_derecha == 5) selected @endif>
                                                Grado 5</option>
                                        </select>
                                        </select>
                                    </td>
                        ...
                        <div class="col-sm">
                            ...
                            <div class="form-group">
                                <select class="form-control formulario" name="pregunta1">
                                    <option value="0" @if ($form->P_pies_juntos == '0') selected @endif>Se
                                        sostuvo
                                        durante 10 segundos</option>
                                    <option value="1" @if ($form->P_pies_juntos == '1') selected @endif>No se
                                        sostuvo durante 10 segundos</option>
                                    <option value="2" @if ($form->P_pies_juntos == '2') selected @endif>Lo
                                        intento
                                        pero no fue capaz</option>
                                    <option value="3" @if ($form->P_pies_juntos == '3') selected @endif>El
                                        sujeto
                                    ...
                                    <option value="6" @if ($form->P_pies_juntos == '6') selected @endif>El
                                        sujeto
                                        no entendió las instrucciónes</option>
                                    <option value="7" @if ($form->P_pies_juntos == '7') selected @endif>Otro
                                        motivo
                                    </option>
                                    <option value="8" @if ($form->P_pies_juntos == '8') selected @endif>El
                                        sujeto
                            ...
                            <div class="form-group">
                                <select class="form-control" name="pregunta2">
                                    <option value="0" @if ($form->P_semitandem == '0') selected @endif>Se
                                        sostuvo
                                        durante 10 segundos</option>
                                    ...
                                    <option value="3" @if ($form->P_semitandem == '3') selected @endif>El
                                        sujeto
                                        no pudo ponerse de pie sin ayuda</option>
                                    ...
                                    <option value="5" @if ($form->P_semitandem == '5') selected @endif>No lo
                                        intentó el sujeto sentía insenguro </option>
                                    <option value="6" @if ($form->P_semitandem == '6') selected @endif>El
                                        sujeto
                                        no entendió las instrucciónes</option>
                                    <option value="7" @if ($form->P_semitandem == '7') selected @endif>Otro
                                        motivo</option>
                                    <option value="8" @if ($form->P_semitandem == '8') selected @endif>El
                                        sujeto
                                        rechazo la prueba</option>
                                </select>
                                </select>
                            ...
                            <div class="form-group">
                                <select class="form-control formulario" name="pregunta3">
                                    ...
                                    <option value="2" @if ($form->P_sandem == '2') selected @endif>Lo
                                        intento pero no fue capaz</option>
                                    <option value="3" @if ($form->P_tandem == '3') selected @endif>El
                                        sujeto
                                        no pudo ponerse de pie sin ayuda</option>
                                    ...
                                    <option value="5" @if ($form->P_tandem == '5') selected @endif>No lo
                                        intentó el sujeto sentía insenguro </option>
                                    <option value="6" @if ($form->P_tandem == '6') selected @endif>El
                                        sujeto
                                        no entendió las instrucciónes</option>
                                    <option value="7" @if ($form->P_tandem == '7') selected @endif>Otro
                                        motivo</option>
                                    <option value="8" @if ($form->P_tandem == '8') selected @endif>El
                                        sujeto
                                        rechazo la prueba</option>
                                </select>
                            </div>
                        ...
                        <div class="col-sm">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleFormControlInput1"
                                    value="{{ $form->Segundos }}" name="total" placeholder="puntuacion">
                            </div>
                                    ...
                                    <div class="col-sm">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">INICIO DE LA MARCHA (Inmediatamente después
                                                            de decir “camine”) </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">Duda o vacila o
                                                                    múltiples
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor1">
                                                                    <option value="0"
                                                                        @if ($marcha->valor1 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor1 == 1) selected @endif>
                                                                        (1)No </option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">El pie derecho no
                                                                    sobrepasa al izquierdo con el paso en la fase del
                                                                    balanceo
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor2">
                                                                    <option value="0"
                                                                        @if ($marcha->valor2 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor2 == 1) selected @endif>
                                                                        (1)No </option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">El pie derecho no se
                                                                    levanta completamente del suelo con el paso en la
                                                                    fase del balanceo
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor3">
                                                                    <option value="0"
                                                                        @if ($marcha->valor3 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor3 == 1) selected @endif>
                                                                        (1)No </option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">El pie izquierdo no
                                                                    sobrepasa el derecho con el paso en la fase del
                                                                    balanceo
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor4">
                                                                    <option value="0"
                                                                        @if ($marcha->valor4 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor4 == 1) selected @endif>
                                                                        (1)No </option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">El pie izquierdo no
                                                                    se levanta completamente del suelo con el paso en la
                                                                    fase del balanceo
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor5">
                                                                    <option value="0"
                                                                        @if ($marcha->valor5 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor5 == 1) selected @endif>
                                                                        (1)No </option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">La longitud del paso
                                                                    con el pie derecho e izquierdo es diferente
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor6">
                                                                    <option value="0"
                                                                        @if ($marcha->valor6 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor6 == 1) selected @endif>
                                                                        (1)No </option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">Para o hay
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor7">
                                                                    <option value="0"
                                                                        @if ($marcha->valor7 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor7 == 1) selected @endif>
                                                                        (1)No </option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">
                                                                    TRAYECTORIA <br>(Estimada en relación a las baldosas
                                                                    del suelo de 30 cm;<br> se observa la desviación de
                                                                    un pie en 3 mts de distancia)
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">Marcada desviación,
                                                                    utiliza ayuda
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor8">
                                                                    <option value="0"
                                                                        @if ($marcha->valor8 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor8 == 1) selected @endif>
                                                                        (1)No </option>
                                                                    <option value="2"
                                                                        @if ($marcha->valor8 == 2) selected @endif>
                                                                        (2)Moderado </option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="formGroupExampleInput">Marcado balanceo o
                                                                    utiliza ayuda,<br> flexión de rodillas, espalda o
                                                                    extensión hacia afuera de los brazos
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor9">
                                                                    <option value="0"
                                                                        @if ($marcha->valor9 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor9 == 1) selected @endif>
                                                                        (1)No </option>
                                                                    <option value="2"
                                                                        @if ($marcha->valor9 == 2) selected @endif>
                                                                        (2)Moderado </option>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control Marcha" name="Valor10">
                                                                    <option value="0"
                                                                        @if ($marcha->valor10 == 0) selected @endif>
                                                                        (0)si</option>
                                                                    <option value="1"
                                                                        @if ($marcha->valor10 == 1) selected @endif>
                                                                        (1)No </option>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="Suma total" name="Total"
                                                                    id="Resultado" value="{{ $marcha->total }}">
                                                            </div>
                                                        </td>
                                                    </tr>
