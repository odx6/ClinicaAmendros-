...
<div class="layout-px-spacing">
                ...
                <h1 style="text-align: center;">EDITAR SECRETARIA</h1>
                <h3>Datos del  la secretaria </h3>
                <h4>Los datos marcados con <span class="red-asterisk">*</span>  son obligatorios</h4>
                        <form class="user needs-validation" method="POST" action="{{ route('update.Secrearia',['id'=>$Secretaria->pk_secretaria]) }}" novalidate>
                            @csrf
