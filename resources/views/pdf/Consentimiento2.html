...
<style >
  ...
  <body>
  <p style="text-align:right;">Oaxaca de Juárez, Oax., a ______de _______________de 20____</p>
...
<table class="table table-sm">
  <thead>
    <tr>
      <th colspan="4" style="background: gray;"><p style="text-align:center;">Paciente</p></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Nombre: </td>
      <td colspan="3">Larry the Bir</td>
      
    </tr>
    <tr>
      <td>Diagnostico: </td>
      <td colspan="3"><p> se requiere mas sessiones alnskasjkalkjjslkals se requiere mas sessiones alnskasjkalkjjslkalsse requiere mas sessiones alnskasjkalkjjslkals se requiere mas sessiones alnskasjkalkjjslkals se requiere mas sessiones alnskasjkalkjjslkals se requiere mas sessiones alnskasjkalkjjslkals se requiere mas sessiones alnskasjkalkjjslkals se requiere mas sessiones alnskasjkalkjjslkalsv se requiere mas sessiones alnskasjkalkjjslkals</p> </td>
    ...
    <tr>
      <td>Domicilio : </td>
      <td colspan="3"> Domicilio 102 4 collas flores</td>
      
    </tr>
     <tr>
      <td>Telefono : </td>
      <td colspan="3"> 9515887515</td>
