...
<div class="layout-px-spacing">
                ...
                <h1 style="text-align: center;">LISTADO DE FACTURAS REGISTRADAS</h1>
                    @if(session('mensaje'))
...
@endif
                    <div class="action-btns">
                         <br><label>Agregar Factura </label>
                       
                        <a href="{{route('create.Facctura')}}" class="action-btn btn-view bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Agregar">
            ...
            <tr>
                ...
                <td class="text">
                    <div class="action-btns">
                        ...
                        <a href="{{route('destroy.Facctura',['id'=>$factu->pk_factura])}}" class="action-btn btn-delete bs-tooltip" data-toggle="tooltip" data-placement="top" title="Elimnar">
