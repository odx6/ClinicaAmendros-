<div id="rotateleftModal" class="modal animated rotateInDownLeft custo-rotateInDownLeft"
role="dialog">
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row mb-4">
                <div class="col">
                    <label for="formGroupExampleInput">Calidad en la que llega el
                        paciente</label>
                    <input type="text" class="form-control"
            ...
            <div class="row mb-4">
                    ...
                    <div class="col-sm-10 offset-sm-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox"
                                id="gridCheck1" value="1" name="Revocar">
                ...
                <div class="col">
                    <div class="col-sm-10 offset-sm-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox"
                                id="gridCheck1" value="1" name="NoAcepta">
                            <label class="form-check-label" for="gridCheck1">
