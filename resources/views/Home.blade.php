                            ...
                            <form class="needs-validation" novalidate id="foreverisa">
                                <div class="modal-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="">
                                                    ...
                                                    <select class="form-control event-title" name="DOCTOR" id="event-title"
                                                        required>
                                                        <option selected disabled value="">Selecciona el medico
                                                        </option>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-rounded mb-2 me-4 btn-add-event"
                                            id="btnAgregar">Agregar Cita</button>
                                        <button type="submit" class="btn btn-primary btn-rounded mb-2 me-4 btn-delete-event"
                                            data-fc-event-public-id="">Cancelar cita</button>
                                    </div>
                                </div>
                            </form>
                        </div>
